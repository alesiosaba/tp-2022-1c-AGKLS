...
int traducir_dir_logica(pcb** pcb, int direccion_logica){
	...
	send_solicitud_tabla_N1(conexionAMemoria, id_tablaN1, entrada_tabla_primer_nivel, SOLICITUD_TABLA_PAGINA_N1);
	...
	send_solicitud_tabla_N2(conexionAMemoria, id_tablaN2, entrada_tabla_segundo_nivel, SOLICITUD_TABLA_PAGINA_N2);
